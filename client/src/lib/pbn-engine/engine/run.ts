...
export async function runEngine(input: EngineInput): Promise<EngineResult> {
  ...
  let colormapResult: ColorMapResult = ColorReducer.createColorMap(kmeansImgData);
 ...
 */
function createReducedPreview(facetResult: FacetResult, colormapResult: ColorMapResult): ImageData {
